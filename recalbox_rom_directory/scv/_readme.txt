=======================================================================
# RECALBOX: System Super Cassette Vision (Home console)
=======================================================================

Copy your Super Cassette Vision ROMs here.
Supported extensions are: .bin .0 .cart .zip

This system can be emulated using 1 emulators.
These emulators are listed below, in order of compatibility/ease of use:
libretro-emuscv supports files of .0 .bin .cart .zip and is NOT Netplay compatible.
...
https://wiki.recalbox.com/en/emulators/consoles/super-cassette-vision