=======================================================================
# RECALBOX: System Atari 2600 (Home console)
=======================================================================

Copy your Atari 2600 ROMs here.
Supported extensions are: .bin .a26 .7z .zip

This system can be emulated using 1 emulators.
These emulators are listed below, in order of compatibility/ease of use:
libretro-stella supports files of .a26 .bin .zip .7z and is  Netplay compatible.
...
https://wiki.recalbox.com/en/emulators/consoles/atari-2600