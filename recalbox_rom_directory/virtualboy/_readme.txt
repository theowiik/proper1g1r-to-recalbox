=======================================================================
# RECALBOX: System Virtual Boy (Home console)
=======================================================================

Copy your Virtual Boy ROMs here.
Supported extensions are: .7z .vb .vboy .bin .zip

This system can be emulated using 1 emulators.
These emulators are listed below, in order of compatibility/ease of use:
libretro-mednafen_vb supports files of .vb .vboy .bin .zip .7z and is NOT Netplay compatible.
...
https://wiki.recalbox.com/en/emulators/consoles/virtualboy