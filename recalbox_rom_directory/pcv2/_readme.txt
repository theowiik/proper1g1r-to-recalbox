=======================================================================
# RECALBOX: System Pocket Challenge v2 (Handheld console)
=======================================================================

Copy your Pocket Challenge v2 ROMs here.
Supported extensions are: .7z .wsc .ws .pc2 .zip

This system can be emulated using 1 emulators.
These emulators are listed below, in order of compatibility/ease of use:
libretro-mednafen_wswan supports files of .ws .wsc .pc2 .zip .7z and is NOT Netplay compatible.
...
https://wiki.recalbox.com/en/emulators/handhelds/pocket-challenge-v2