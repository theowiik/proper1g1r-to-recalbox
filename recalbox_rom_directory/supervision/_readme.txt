=======================================================================
# RECALBOX: System Watara Supervision (Handheld console)
=======================================================================

Copy your Watara Supervision ROMs here.
Supported extensions are: .bin .7z .sv .zip

This system can be emulated using 1 emulators.
These emulators are listed below, in order of compatibility/ease of use:
libretro-potator supports files of .sv .bin .zip .7z and is NOT Netplay compatible.
...
https://wiki.recalbox.com/en/emulators/handhelds/supervision