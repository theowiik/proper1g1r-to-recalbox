=======================================================================
# RECALBOX: System Othello Multivision (Home console)
=======================================================================

Copy your Othello Multivision ROMs here.
Supported extensions are: .7z .sg .bin .mv .zip

This system can be emulated using 1 emulators.
These emulators are listed below, in order of compatibility/ease of use:
libretro-gearsystem supports files of .mv .bin .sg .zip .7z and is NOT Netplay compatible.
...
https://wiki.recalbox.com/en/emulators/consoles/multivision