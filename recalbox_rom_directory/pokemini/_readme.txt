=======================================================================
# RECALBOX: System Pokémon Mini (Handheld console)
=======================================================================

Copy your Pokémon Mini ROMs here.
Supported extensions are: .min .zip

This system can be emulated using 1 emulators.
These emulators are listed below, in order of compatibility/ease of use:
libretro-pokemini supports files of .min .zip and is NOT Netplay compatible.
...
https://wiki.recalbox.com/en/emulators/handhelds/pokemini