=======================================================================
# RECALBOX: System Atari 5200 (Home console)
=======================================================================

Copy your Atari 5200 ROMs here.
Supported extensions are: .bin .a52 .zip

This system can be emulated using 2 emulators.
These emulators are listed below, in order of compatibility/ease of use:
libretro-atari800 supports files of .a52 .zip and is NOT Netplay compatible.
libretro-a5200 supports files of .a52 .bin .zip and is NOT Netplay compatible.
...
https://wiki.recalbox.com/en/emulators/consoles/atari-5200